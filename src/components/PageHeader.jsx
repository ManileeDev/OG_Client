...
export default function PageHeader({ kicker, title, subtitle, action, children }) {
  return (
    <div className="relative mb-4 lg:sticky lg:top-0 lg:z-30 lg:-mx-8 lg:-mt-8 lg:bg-surface/95 lg:px-8 lg:pb-2 lg:pt-8 lg:backdrop-blur">
      <div className="flex min-w-0 flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 max-w-full">
          ...
          {subtitle && <p className="mt-1 max-w-full break-words text-sm text-ink-dim">{subtitle}</p>}
        </div>
        {action}
      </div>
